...
public class InventorySave {
    private static InventorySave instance = new InventorySave(RPG_Base.getInstance());
    private Map<UUID, InventoryStore> inventories = new HashMap<>();

    /**
     * Saves the inventory of a player
     * @param plugin - ASkyBlock plugin object - ASkyBlock plugin
     */
    public InventorySave(RPG_Base plugin) {
