...
public class DeleteIslandChunk {
    ...
    public DeleteIslandChunk(final RPG_Base plugin, final Island island) {
                        ...
                        for (int x = 0; x < 16; x ++) {
                            for (int z = 0; z < 16; z ++) {
                                ...
                                if (island.inIslandSpace(xCoord, zCoord)) {
                                    ...
                                    for (int y = 0; y < RPG_Base.getIslandWorld().getMaxHeight(); y ++) {
                                        // Overworld
                                        Block block = RPG_Base.getIslandWorld().getBlockAt(xCoord, y, zCoord);
