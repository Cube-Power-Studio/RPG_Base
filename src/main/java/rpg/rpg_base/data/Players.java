...
import rpg.rpg_base.IslandManager.events.TeamJoinEvent;
import rpg.rpg_base.IslandManager.events.TeamLeaveEvent;
...
public class Players {
    ...
    /**
     * @param rpg_base - plugin
     * @param uuid - player's uuid
     * @throws IOException - if uuid is null
     */
    public Players(final RPG_Base rpg_base, final UUID uuid) throws IOException {
